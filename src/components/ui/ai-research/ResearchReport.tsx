...
const ResearchReport = () => {
  const { report, isCompleted, isLoading, topic } = useAIResearchStore();
  ...
  return (
    <Card className="max-w-[90vw] xl:max-w-[60vw] relative px-4 py-6 rounded-xl border-black/10 border-solid shadow-none p-6 bg-white/60 backdrop-blur-xl border antialiased">
